...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> <!--lables and fields can be added below this line-->
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="e.g. Harry Potter" />
    ...
    <div class="row">
        <div class="col-md-6 offset-3" style="margin-top: 100px">
            <a class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Book</a>
        </div>
    </div>
                    ...
                    success: function(response) {
                        ...
                        if (response) {
                            Swal.fire({ // use sweet alert success alert
                                title: response.success,  // get the title from the backend response
                                icon: "success",
                                draggable: true
                            });
                        }
